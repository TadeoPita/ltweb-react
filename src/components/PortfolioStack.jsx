...
function CardVisual({ project }) {
  return (
    <div className="absolute inset-0 rounded-3xl overflow-hidden border border-white/10 bg-white/[0.03] shadow-2xl shadow-black/50">
      <img
        src={project.image}
        alt={project.name}
        draggable={false}
...
function CtaVisual() {
  return (
    <div className="absolute inset-0 rounded-3xl overflow-hidden border-2 border-dashed border-white/25 bg-gradient-to-br from-[#3b2a8f] to-[#5a2ea6] flex flex-col items-center justify-center gap-6 text-center p-8 shadow-2xl shadow-black/50">
